...
def ask_image():
    ...
    while True:
        ...
        if os.path.getsize(p) > MAX_MB * 1024 * 1024: print("Too large"); continue
        return p
...
def main():
    ...
    out= f"annotated_{datetime.now().strftime('%Y%m%d_%H%M%S')}.jpg"
    ...
    if counts:
        ...
        print("Disclaimer: This is a demo and may not work perfectly." \
